...
<head>
    ...
    <style>
        ...
        /* Sayfa kaydırma sorununu kökten çözen ana ayarlar */
        html, body {
            ...
            min-height: 100vh;
            overflow-y: scroll !important; /* Yukarı aşağı kaymayı zorunlu yapıyoruz */
        }
        ...
        .group-container {
            ...
            border-radius: 12px;
            padding: 1.5rem;
            margin-bottom: 2rem; /* Grupların arasını açar */
        ...
        /* Komut Satırları (Her komut tek bir satır kaplar, buton alt tarafa veya sağa taşmaz) */
        .command-row {
            background: #0f172a;
            border: 1px solid var(--border-color);
            border-radius: 8px;
            ...
            margin-bottom: 1rem;
            display: flex;
            flex-direction: column; /* Alt alta düzenli dursunlar diye */
            gap: 12px;
        }
        ...
        .copy-btn {
            ...
            justify-content: center;
            gap: 8px;
            width: 100%; /* Mobil uyum için tam genişlik */
            margin-top: 5px;
        }
        ...
        .badge { padding: 6px 10px; border-radius: 6px; font-size: 0.8rem; font-weight: 600; background: rgba(34, 197, 94, 0.2); color: #22c55e; }

        /* Geniş Ekranlar İçin Düzenleme */
        @media (min-width: 768px) {
            #main-panel { display: none; grid-template-columns: 280px 1fr; }
            .sidebar { height: 100vh; position: sticky; top: 0; border-right: 1px solid var(--border-color); border-bottom: none; }
            .menu-list { flex-direction: column; }
            .topbar { flex-direction: row; justify-content: space-between; align-items: center; }
            .search-box { width: 350px; }
            .copy-btn { width: auto; align-self: flex-end; }
    ...
    <div id="main-panel">
        ...
        <main class="content">
            ...
            <div id="section-tedavi" class="panel-section">
                <div class="page-header"><h1>Tedavi ve Operasyon Komutları</h1></div>
    ...
    <script>
        ...
        function checkPassword() {
            ...
            if (pwd === "musaku32") {
                ...
                // Ekran genişliğine göre grid veya blok düzenini ayarla
        ...
        function switchTab(tabName) {
            ...
            // Sekme değiştiğinde sayfayı otomatik en yukarı kaydır
            window.scrollTo(0, 0);
        }
